...
@implementation VLStringMemoryRecord
@end

@interface VLStringMemorySession ()
...
@implementation VLStringMemorySession
...
- (NSArray<VLStringMemoryRecord *> *)records {
  ...
  while (i < total) {
    ...
    VLStringMemoryRecord *record = [VLStringMemoryRecord new];
