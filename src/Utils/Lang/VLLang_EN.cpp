...
std::map<std::string, std::string> getLangEN() {
    return {
      {"Str_Undo_Button", "Undo"},
      {"Str_Reload_Button", "Reload"},
        // Tab Labels
        {"Tab_Ptr", "Pointer"},
        {"Tab_RVA", "RVA"},
        {"Tab_Sig", "Signature"},
        ...
        {"Str_Write_Unverified", "The write could not be verified. Some bytes may have changed; the original snapshot is retained for undo. Check the target before continuing."},
        {"Str_No_Undo", "No edits to undo in this editor session."},
        {"Str_Reload", "Reload selected memory"},
        {"Str_Load_Before", "← 1 KB"},
        {"Str_Load_After", "1 KB →"},
        {"Str_Select_Range", "Edit range"},
        {"Str_Context", "Nearby candidate strings (tap to edit)"},
        {"Str_Range_Mode", "Range · escaped bytes · equal-length write"},
        {"Str_Single_Mode", "Single string · tap nearby rows to switch"},
        {"Str_Escape_Help", "Equal bytes; \\0 = zero, \\xNN = hex, \\\\ = backslash"},
        {"Str_Shorter_Allowed", "Equal or shorter; writes a zero terminator"},
        {"Str_Count_Fmt", "Original %lu B · Edited %lu B\n%@"},
        {"Str_Unsaved", "Save the current draft?"},
        {"Str_Discard", "Discard draft"},
        {"Str_Range_Help", "Select contiguous bytes, up to 8192. Addresses are hexadecimal and the end is inclusive. Separators and binary bytes appear as escapes. Writes must keep the same byte count."},
        {"Str_Start", "Start address (hex)"},
        {"Str_End", "End address (inclusive, hex)"},
        {"Str_Saved", "Write verified. You can continue editing or undo this change."},
        {"Str_Range_Preview", "0x%llX – 0x%llX\n%lu bytes, equal-length replacement\n\nBefore: %@\n\nAfter: %@"},
        {"Btn_Hide_Keyboard", "Hide Keyboard"},
        {"Btn_Close", "Close"},
        {"Btn_OK", "OK"},
        {"Btn_Edit", "Edit"},
        {"Btn_Delete", "Delete"},
        ...
        {"Timeline_Restore_Values_Title", "Restore Memory Values"},
        {"Timeline_Restore_Values_Msg", "Restore the values captured by this search snapshot?"},
        {"Timeline_Restore_Values_Action", "Restore Values"},
        {"Timeline_Restore_Values_Success_Fmt", "Restored %lu memory values"},
        ...
        {"Snapshot_Title", "Value Snapshot"},
        {"Snapshot_Save", "Capture Current Values"},
        {"Snapshot_Restore", "Restore Snapshot Values"},
        {"Snapshot_Saved_Fmt", "Captured %lu values"},
        {"Snapshot_Restored_Fmt", "Restored %lu values"},
        {"Snapshot_Empty", "No readable values"},
